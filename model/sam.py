...
class SAM():
    def __init__(self, encoder_version, checkpoint_path, device) -> None:
        self.sam_predictor = self.load_sam_predictor(encoder_version, checkpoint_path, device)
    def load_sam_predictor(self, encoder_version, checkpoint_path, device) -> SamPredictor:
